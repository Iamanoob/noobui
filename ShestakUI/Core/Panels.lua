...
if C.chat.background == true then
	...
	if C.chat.tabs_mouseover ~= true then
		...
		chattabs:CreatePanel("Transparent", chatbd:GetWidth(), 20, "BOTTOM", chatbd, "TOP", 0, 0)
	...
	leftpanel:CreatePanel("ClassColor", 1, C.chat.height - 2, "BOTTOMLEFT", bottompanel, "LEFT", 0, 50)
end

---------------------------------Noob panels--------------------------------------------
boonframecenter = CreateFrame("Frame", "boonframecenter", UIParent);
boonframecenter:SetSize(580, 210);
boonframecenter:SetPoint("BOTTOM", 0, 2);
boonframecenter:SetBackdrop( { 
boonframecenter:SetFrameStrata("background");
bgFile = "Interface/AddOns/ShestakUI/media/backgrounds/cpanel2.tga",
insets = { left = 0, right = 0, top = 0, bottom = 0 }
});

boonframeleft = CreateFrame("Frame", "boonframeleft", UIParent);
boonframeleft:SetSize(260, 210);
boonframeleft:SetPoint("BOTTOM", -420, 2);
boonframeleft:SetBackdrop( { 
boonframeleft:SetFrameStrata("background");
bgFile = "Interface/AddOns/ShestakUI/media/backgrounds/lpanel2.tga",
insets = { left = 0, right = 0, top = 0, bottom = 0 }
});

boonframeright = CreateFrame("Frame", "boonframeright", UIParent);
boonframeright:SetSize(260, 210);
boonframeright:SetPoint("BOTTOM", 420, 2);
boonframeright:SetBackdrop( { 
boonframeright:SetFrameStrata("background");
bgFile = "Interface/AddOns/ShestakUI/media/backgrounds/rpanel2.tga",
insets = { left = 0, right = 0, top = 0, bottom = 0 }
});
