...
C["position"] = {
	...
	["minimap"] = {"TOPRIGHT", UIParent, "TOPRIGHT", -21, -25},						-- Minimap
	["map"] = {"BOTTOM", UIParent, "BOTTOM", -120, 320},							-- Map
	["chat"] = {"BOTTOMLEFT", UIParent, "BOTTOMLEFT", 740, 30},						-- Chat
	["bag"] = {"BOTTOMRIGHT", Minimap, "TOPRIGHT", -22, -750},						-- Bag
	...
	["tooltip"] = {"BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -2, -5},					-- Tooltip
	...
	["player_buffs"] = {"TOPRIGHT", UIParent, "TOPRIGHT", -200, -11},				-- Player buffs
	...
	-- ActionBar positions
	["bottom_bars"] = {"BOTTOM", UIParent, "BOTTOM", 6, 35},						-- Bottom bars
	...
	unitframes = {
		...
		["boss"] = {"BOTTOMRIGHT", UIParent, "RIGHT", -630, -70},					-- Boss frames
		["tank"] = {"BOTTOMLEFT", "ActionBarAnchor", "BOTTOMRIGHT", 80, 120},		-- Tank frames
		...
		["player_castbar"] = {"BOTTOM", "ActionBarAnchor", "TOP", 0, 20},		    -- Player Castbar
