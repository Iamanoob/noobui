...
C["chat"] = {
	...
	["width"] = 336,							-- Chat width
	["height"] = 98,							-- Chat height
...
C["actionbar"] = {
	...
	-- Right bars
	["rightbars"] = 1,							-- Number of action bars on right (0, 1, 2 or 3)
...
C["unitframe"] = {
	...
	["class_icons_portraits"] = false,			-- Class icon portraits for player/target (you need to disable the option for player/target portraits)
