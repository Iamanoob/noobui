...
LPSTAT_FONT = {
	...
	color = {255, 255, 0},						-- {red, green, blue} or "CLASS"
...
-- Bottomleft block
	Clock = {
		...
		x_off = 1150, y_off = 14, tip_frame = "UIParent", tip_anchor = "BOTTOMLEFT", tip_x = 28, tip_y = 30
	},
	Latency = {
...
-- Bottomright block
	...
	Location = {
		...
		x_off =  50 or 0, y_off = 110, tip_frame = "UIParent", tip_anchor = "BOTTOMRIGHT", tip_x = -21, tip_y = 20
	},
-- Top block
	Stats = {
